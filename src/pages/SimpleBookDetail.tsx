...
// Simple book type to avoid TypeScript issues
type Book = {
  id: string;
  title: string;
  author: string;
...
const SimpleBookDetail = () => {
  // Get multiple possible parameter names from the URL
  const params = useParams<{ id?: string; workId?: string }>();
  // Use either the regular id or the workId from OpenLibrary URLs
  const id = params.id || params.workId;
...
export default SimpleBookDetail;
